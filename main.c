...
int verificacaz1T(int pozitie_linie,int pozitie_coloana,int numar_linii,int numar_coloane,short matrice[1000][1000])
{
...
int verificacelulaP(int pozitie_linie,int pozitie_coloana,int numar_linii,int numar_coloane,short matrice[1000][1000])
{
...
int verificacelulaT(int pozitie_linie,int pozitie_coloana,int numar_linii,int numar_coloane,short matrice[1000][1000])
{
